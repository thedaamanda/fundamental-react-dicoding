...
function ActionButton({ id, archived, onDelete, onArchived }) {
    return (
        <div className="button-list">
            <button className="template-btn-item success" onClick={() => onArchived(id)}>
                <span>{archived ? "Pulihkan Catatan" : "Arsipkan Catatan"}</span>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="20" heigth="20">
            ...
            <button className="template-btn-item warning">
            ...
            <button className="template-btn-item danger" onClick={() => onDelete(id)}>
                <span>Hapus Catatan</span>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="18" heigth="18">
