        ...
        <div className="form-box-body">
            <form className="form" id="register-form" onSubmit={onSubmitHandler}>
                <div className="form-group">
                    ...
                    <input type="text" id="name" name="name" placeholder={text.input.placeholder.name} value={name} onChange={onNameChange} />
                </div>
                <div className="form-group">
                ...
                <div className="form-group">
                    <label htmlFor="password_confirmation">{text.input.label.confirmPassword}</label>
                    <input type="password" id="password_confirmation" name="password_confirmation" placeholder={text.input.placeholder.confirmPassword} value={confirmPassword} onChange={onConfirmPasswordChange} autoComplete="on" />
                </div>
                <div className="form-group field-group">
                    <button type="submit" id="btnRegisterForm">{text.register}</button>
                </div>
            </form>
        </div>
    );
